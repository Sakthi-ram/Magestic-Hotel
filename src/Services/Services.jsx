    ...
    <>
      <div className='service'>
        ...
        <div className='service-text1'>
          <h4>DINNING</h4>
          <h2>Dishes</h2>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic aperiam quaerat facere eaque consectetur nostrum. Reprehenderit ea placeat facere unde aut eos dolore. Cupiditate cum enim officiis eligendi molestiae! Accusamus, quos quia? Voluptate eaque nostrum iusto? Magnam velit fugiat in asperiores iure repellat nemo facere sapiente eos a, commodi laboriosam inventore rem cupiditate suscipit ipsum quibusdam sequi possimus delectus temporibus est. Architecto voluptatibus veniam quo officia perspiciatis eum, praesentium iure dicta ut! A modi, ipsam iste dolor nobis illum, beatae nulla nesciunt dolorem, culpa voluptatum vitae labore dignissimos. Architecto nostrum accusantium maiores incidunt aperiam blanditiis, recusandae sint eum ab dolorem!</p></div>
        <div className='service-dinning'>
          <Carousel>
